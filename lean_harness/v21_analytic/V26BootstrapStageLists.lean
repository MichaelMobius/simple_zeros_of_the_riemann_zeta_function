...
/-- Published codes after the first rational bootstrap pass.  This file only
checks their finite bookkeeping; the quadratic certificate proves the pass. -/
...
/-- Published codes after the second rational bootstrap pass. -/
...
/-- Published five final codes. -/
def v26Round3Codes : Finset Nat := [121212, 121221, 122121, 212121, 212212].toFinset

/-- Stage predicates used by the forthcoming rational certificate. -/
def v26InRound1 (w : V26BasinWord) : Prop := v26WordCode w ∈ v26Round1Codes
def v26InRound2 (w : V26BasinWord) : Prop := v26WordCode w ∈ v26Round2Codes
def v26InRound3 (w : V26BasinWord) : Prop := v26WordCode w ∈ v26Round3Codes

/-- The first published code table contains exactly 231 distinct codes. -/
theorem v26_round1_code_count : v26Round1Codes.card = 231 := by
  set_option maxHeartbeats 0 in
  set_option maxRecDepth 100000 in
  decide

/-- The second published code table contains exactly 23 distinct codes. -/
theorem v26_round2_code_count : v26Round2Codes.card = 23 := by
  set_option maxHeartbeats 0 in
  set_option maxRecDepth 100000 in
  decide

/-- The final published code table contains exactly five distinct codes. -/
theorem v26_round3_code_count : v26Round3Codes.card = 5 := by
  set_option maxHeartbeats 0 in
  set_option maxRecDepth 100000 in
  decide

/-- Bookkeeping nesting of the published stages. -/
theorem v26_round2_subset_round1 : v26Round2Codes ⊆ v26Round1Codes := by
  set_option maxHeartbeats 0 in
  set_option maxRecDepth 100000 in
  decide

theorem v26_round3_subset_round2 : v26Round3Codes ⊆ v26Round2Codes := by
  set_option maxHeartbeats 0 in
  set_option maxRecDepth 100000 in
  decide

/-- Exact final code set, written as a theorem so downstream files need not
unfold the list representation. -/
theorem v26_round3_codes_exact :
    v26Round3Codes = {121212, 121221, 122121, 212121, 212212} := by
  set_option maxHeartbeats 0 in
  set_option maxRecDepth 100000 in
  decide
