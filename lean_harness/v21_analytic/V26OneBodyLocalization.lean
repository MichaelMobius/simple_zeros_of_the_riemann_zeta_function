...
theorem v26_localize_A_of_below {x : ℝ}
  ...
  · by_cases hUA1 : x ≤ (579 / 500 : ℝ)
    · exact ⟨(0 : Fin 7), by
        simpa [v26InA, v26ALo, v26AHi, Matrix.cons_val_succ'] using
          (And.intro hLA1 hUA1)⟩
...
theorem v26_localize_B_of_below {x : ℝ}
  ...
  · by_cases hUB1 : x ≤ (579 / 500 : ℝ)
    · exact ⟨(0 : Fin 5), by
        simpa [v26InB, v26BLo, v26BHi, Matrix.cons_val_succ'] using
          (And.intro hLB1 hUB1)⟩
...
theorem v26_localize_C_of_below {x : ℝ}
  ...
  · by_cases hUC1 : x ≤ (579 / 500 : ℝ)
    · exact ⟨(0 : Fin 6), by
        simpa [v26InC, v26CLo, v26CHi, Matrix.cons_val_succ'] using
          (And.intro hLC1 hUC1)⟩
...
theorem v26_onebody_thresholds_of_counterexample
    ...
    ((1357 / 5000000 : ℝ) * g0 + (1 / 3 : ℝ) * limitingWeight g0 <
        (2081 / 1000000 : ℝ)) ∧
    ((3733 / 10000000 : ℝ) * g1 + (1 / 3 : ℝ) * limitingWeight g1 <
        (2189 / 1000000 : ℝ)) ∧
    ((3553 / 10000000 : ℝ) * g2 + (1 / 3 : ℝ) * limitingWeight g2 <
        (217 / 100000 : ℝ)) ∧
    ((3553 / 10000000 : ℝ) * g3 + (1 / 3 : ℝ) * limitingWeight g3 <
        (217 / 100000 : ℝ)) ∧
    ((3733 / 10000000 : ℝ) * g4 + (1 / 3 : ℝ) * limitingWeight g4 <
        (2189 / 1000000 : ℝ)) ∧
    ((1357 / 5000000 : ℝ) * g5 + (1 / 3 : ℝ) * limitingWeight g5 <
        (2081 / 1000000 : ℝ)) := by
  ...
  have hsumle :=
    v26_oneBodySum_le_gapF limitingWeight v26_limitingWeight_nonneg
      g0 g1 g2 g3 g4 g5
  have hsumlt : v26OneBodySum limitingWeight g0 g1 g2 g3 g4 g5 < v26Delta :=
    lt_of_le_of_lt hsumle hbad
  norm_num [v26OneBodySum, v26Delta, v26Pressure, Matrix.cons_val_succ'] at hsumlt
  constructor
...
theorem v26_basin_localization :
    V26BasinLocalizationClaim limitingWeight := by
  intro g0 g1 g2 g3 g4 g5 h0 h1 h2 h3 h4 h5 _hsum hbad
  rcases v26_onebody_thresholds_of_counterexample
      g0 g1 g2 g3 g4 g5 h0 h1 h2 h3 h4 h5 hbad with
